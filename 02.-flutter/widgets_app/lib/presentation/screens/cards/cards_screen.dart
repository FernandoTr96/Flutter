    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          ...cards.map((card)=> _CardTypeImage(label: card['label'], elevation: card['elevation'])),
...
class _CardTypeImage extends StatelessWidget {

  final String label;
  final double elevation;
  
  const _CardTypeImage({required this.label, required this.elevation});
