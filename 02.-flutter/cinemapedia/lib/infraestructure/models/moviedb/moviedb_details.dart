...
MoviedbDetails moviedbDetailsFromJson(String str) => MoviedbDetails.fromJson(json.decode(str));

String moviedbDetailsToJson(MoviedbDetails data) => json.encode(data.toJson());
